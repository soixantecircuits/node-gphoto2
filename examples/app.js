  ...
  app.get('/preview*', function(req, res) {
    if (!camera) {
      ...
      if (preview_listeners.length === 1) {
        // Using XXXXXX filename is mandatory as it uses mkstemp which requires it.
        // The APN should not be set in movie mode.
        var pathImg = __dirname + '/tmp/foo.XXXXXX';
        //console.log('About to use: ', pathImg);
        return camera.takePicture({
          preview: true,
          //targetPath: pathImg
        }, function(er, data) {
          ...
          for (_i = 0, _len = tmp.length; _i < _len; _i++) {
            ...
            if (!er) {
              ...
              listener.write(JSON.stringify({ error: er }));
            }
